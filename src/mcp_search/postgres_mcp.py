"""MCP server for read-only PostgreSQL access to application databases."""
...
DATABASES = ("finance", "mylocation", "scrobble", "pipeline", "wine", "homeassistant", "journal", "joplin", "paperless", "linkwarden", "splitwise", "obligations", "usage", "stuff", "pif", "weather_compare")
...
async def pg_discover_schema(
    ...
    Args:
        database: Database name — one of: finance, mylocation, scrobble, pipeline, wine, homeassistant, journal, joplin, paperless, linkwarden, splitwise, obligations, usage, stuff, pif, weather_compare
